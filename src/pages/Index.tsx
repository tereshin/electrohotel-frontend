      ...
      <div className="min-h-screen bg-white max-w-[2048px] mx-auto">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute inset-x-0 bottom-[40px] md:bottom-[100px] z-10 max-w-[1460px] mx-auto px-4 -mt-20 text-white"
          >
            <BookingForm />
          </motion.div>
        </motion.section>
        ...
        <motion.section 
          {...fadeInUp}
          className="py-8 md:py-10 px-4 md:px-10 md:mt-10"
        >
          <div className="max-w-content mx-auto flex flex-col gap-8 md:gap-14">
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center justify-between">
              ...
              <motion.div 
                {...fadeInUp}
                transition={{ delay: 0.2 }}
                className="w-full md:max-w-[500px] flex flex-col gap-10"
              >
              ...
              <motion.div 
                ...
                className="w-full h-[0px] pb-[100%] md:max-w-[431px] md:h-[428px] md:pb-0 relative overflow-hidden"
              >
                <img
              ...
              <motion.div 
                ...
                className="w-full md:w-[283px] flex flex-col gap-10 uppercase tracking-light"
              >
                {/* Feature 1 */}
        ...
        <motion.section 
          {...fadeInUp}
          className="py-8 md:py-10 px-4 md:px-10"
        >
          <div className="max-w-content mx-auto flex flex-col gap-8 md:gap-14">
            <div className="text-center">
