...
const FirstSection: React.FC<FirstSectionProps> = ({ title = 'Заголовок' }) => {
  return (
    <section className="relative bg-[#023D30] overflow-hidden">
      ...
      {/* Content container */}
      <div className="relative z-10 pt-40 pb-16 flex flex-col items-center justify-between max-w-[1400px] mx-auto px-4 md:px-10">
        {/* Title */}
